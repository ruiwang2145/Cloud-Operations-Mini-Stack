"""
Django settings for my_cloudapp project.
...
if SENTRY_DSN:
    sentry_sdk.init(
        ...
        traces_sample_rate=SENTRY_TRACES_SAMPLE_RATE,   # APM 采样率
        profiles_sample_rate=SENTRY_PROFILES_SAMPLE_RATE,  # 性能剖析
        send_default_pii=True,  # 不上传可识别个人信息
    )
...
# sentry_sdk.init(
#     dsn="https://bbb246bbbe3b7f63379eba3e5ff036b4@o4509968628776960.ingest.de.sentry.io/4509968924016720",
